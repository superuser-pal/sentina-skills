...
description: General-purpose browser automation with Playwright. Auto-detects dev servers, writes and runs custom test scripts for pages, forms, screenshots, responsive checks, and login flows.
disable-model-invocation: true
license: MIT
argument-hint: "the page, flow, or interaction to test in a browser"
metadata:
  author: "lackeyjb (original Playwright skill), packaged via tech-leads-club/agent-skills, adapted for Sentina"
  version: "4.1.0"
---
...
Unlike the rest of this repo, this skill has a real runtime dependency: it ships `package.json`, `run.js`, and `lib/helpers.js`, and needs `npm install` plus a downloaded Chromium binary before first use (see Setup below).
