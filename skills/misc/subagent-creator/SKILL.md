...
description: Guide for creating agent-agnostic subagent definitions with isolated context for complex, multi-step, or verification-heavy work.
disable-model-invocation: true
license: MIT
argument-hint: "the responsibility the new subagent should own"
metadata:
  author: "Tech Leads Club (tech-leads-club/agent-skills)"
  version: "1.0.0"
---
